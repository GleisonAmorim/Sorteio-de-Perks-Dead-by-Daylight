        ...
        document.getElementById('sortearCombinadoBtn').addEventListener('click', () => {
            const quantidade = 4; // Defina aqui quantas perks sortear (ou use uma entrada do usuário)
        ...
        function sortearPerks(quantidade) {
            ...
            // Sorteia uma perk exclusiva obrigatoriamente
            const perkExclusiva = perksExclusivas[Math.floor(Math.random() * perksExclusivas.length)];
